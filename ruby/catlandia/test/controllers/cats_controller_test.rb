...
class CatsControllerTest < ActionController::TestCase
  ...
  test "should create cat" do
    assert_difference('Cat.count') do
      post :create, cat: { breed: @cat.breed, description: @cat.description, image: @cat.image, origin: @cat.origin }
    end
  ...
  test "should update cat" do
    patch :update, id: @cat, cat: { breed: @cat.breed, description: @cat.description, image: @cat.image, origin: @cat.origin }
    assert_redirected_to cat_path(assigns(:cat))
  end
